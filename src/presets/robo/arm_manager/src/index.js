...
//      parent 绑到 preset 作用域, 与 agent 作用域为兄弟分支 —— 臂实例不上浮);
...
// (各会话共享), 但每条臂的作用域与注册按 agent/created + agent/disposed 事件
...
export function apply(ctx) {
  ...
  function setupSession(agent) {
    ...
    sessionArms.set(agent, { keys, scopes, unregister })
