...
| 07 | `07-rigid-transform` | rotation matrix / Euler / **quaternion** / homogeneous transform + MuJoCo scene | arm moves + three pose representations convert consistently | first robotics cornerstone |
...
| 13 | `13-hotplug` | **★ capability hot-plugging + reliability design** (verification/multi-version/rollback/event/isolation/reclaim) | add/remove end-effector tools at runtime, agent-unaware | **flagship demo; the implementation of the novelty claim** |
